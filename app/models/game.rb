class Game < ApplicationRecord
  ...
  def ai_report
    ...
    prompt += "7. ПАРАЛЛЕЛЬНАЯ ЛИНИЯ: Напиши о судьбе изгнанных. Дай им крошечный шанс (7%) на выживание на поверхности — возможно, они нашли другое убежище или приспособились, используя свой багаж?\n"
    prompt += "8. ИТОГ: Что стало с человечеством через #{bunker_duration} лет? Чем закончилась их история, когда двери бункера открылись? Напиши драматичный финал."
